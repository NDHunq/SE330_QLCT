...
notificationContainer
  .bind<INotificationService>(ITYPES.Service)
  .to(NotificationService);
notificationContainer
  .bind<INotificationController>(ITYPES.Controller)
  .to(NotificationController);

//Import
notificationContainer
  .bind<IUserRepository<any>>(REPOSITORY_TYPES.User)
  .toConstantValue(userRepository);

const notificationService = notificationContainer.get<INotificationService>(
  ITYPES.Service
);
const notificationController =
  notificationContainer.get<INotificationController>(ITYPES.Controller);
